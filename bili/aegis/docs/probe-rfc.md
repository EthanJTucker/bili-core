...
**Status:** Draft v0.1
**Author:** Ethan Tucker
**Target:** `bili-core` (fork: `etucker/bili-core`, branch: `aegis-probe`)
**Upstream contact:** MSU Denver bili-core maintainer (verbal go-ahead received; fork must remain open-source)
...
Cyber-GOAT, the autonomous OT-environment penetration testing prototype I
developed at NREL in 2025, sits in the same family — an LLM agent that probed an
